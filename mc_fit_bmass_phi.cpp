...
void mc_fit_bmass_phi(){
  ...
  ch->Add("sel_BsToJPSiPhi_2016_*_mc_cut0_s0.root");
  TTree *tr = ch;
  ...
  RooRealVar Phimass("Phimass","#it{m(KK) (GeV/c^{2})}", 1., 1.04);
  ...
  RooRealVar lambda("lambda","slope", -1., 1.);
  ...
  //RooRealVar a0("a0", "constant", 90000, 1000, 1.e6);
  //RooRealVar a1("a1", "linear", -20000, -1.e6, -1.);
  ...
  mark->DrawLatex(0.75,startY,"#scale[0.8]{566.578 fb^{-1} fb^{-1} (13 TeV)}");
